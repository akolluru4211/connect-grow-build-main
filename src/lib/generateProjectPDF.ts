...
function addFooter(doc: jsPDF, pageNum: number, totalPages: number) {
  ...
  doc.text("Generated by EdWorld | edworldco.lovable.app", MARGIN, FOOTER_Y);
...
function buildCoverPage(doc: jsPDF, p: ProjectIdea): number {
  ...
  doc.setFontSize(9);
  doc.setTextColor(...LIGHT_GRAY);
  doc.text(`Generated on ${new Date().toLocaleDateString("en-IN", { day: "numeric", month: "long", year: "numeric" })}`, PAGE_W / 2, y, { align: "center" });
  doc.text("EdWorld - edworldco.lovable.app", PAGE_W / 2, y + 6, { align: "center" });
