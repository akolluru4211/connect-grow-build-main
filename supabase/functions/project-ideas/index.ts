...
serve(async (req: Request) => {
  ...
  console.log(`[${requestId}] Starting project ideas request`);
...
- estimatedCost: "Free", "Low (<₹500)", or "Moderate (₹500-2000)"
- uniqueSellingPoint: What makes this project stand out`
    ...
    console.log(`[${requestId}] Project ideas generation successful`);
    return createStandardResponse(result, requestId);
  } catch (error) {
    console.error(`[${requestId}] Project ideas error:`, error);
