...
import { Eye, EyeOff, Loader2, Phone, Copy, Mail, CheckCircle2, Github, Apple } from "lucide-react";
...
export default function Auth() {
  ...
  const signInWithApple = auth?.signInWithApple;
  const signInWithMicrosoft = auth?.signInWithMicrosoft;
  ...
  const handleSocialLogin = async (provider: 'google' | 'github' | 'apple' | 'microsoft') => {
    ...
    try {
      ...
      switch (provider) {
        ...
        case 'github': result = await signInWithGithub!(); break;
        case 'apple': result = await signInWithApple!(); break;
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="h-14 pl-11 rounded-2xl border-border bg-muted/30 font-bold focus:bg-background transition-all shadow-sm"
          ...
          <div className="mt-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button 
                ...
                disabled={loading}
                className="h-14 rounded-2xl border-border bg-muted/20 font-bold hover:bg-muted/40 transition-all flex items-center justify-center gap-2"
              >
